...
#include "/Users/erik/Projects/Carp/core/carp_stdint.h"
...
// Depth 3
typedef char*(*Fn__String_char_MUL_)(String);
...
// Depth 3
typedef String(*Fn__char_MUL__String)(char*);

// Depth 3
typedef bool(*Fn__char_MUL__bool)(char*);
...
// Depth 5
typedef Agent(*Fn__Agent_Agent)(Agent);

// Depth 5
typedef Agent(*Fn__Agent_Fn__float_float_MUL__Agent)(Agent, Lambda*);

// Depth 5
typedef Agent(*Fn__LambdaEnv_Agent_Agent)(LambdaEnv, Agent);

// Depth 5
typedef Agent(*Fn___Agent)();

// Depth 5
typedef Agent(*Fn__float_float_Agent)(float, float);
...
// Depth 103
typedef Array__Agent(*Fn__Array__Agent_Array__Agent)(Array__Agent);

// Depth 103
typedef int(*Fn__Array__Agent_MUL__int)(Array__Agent*);

// Depth 103
typedef void(*Fn__Array__Agent_MUL__int_Agent_void)(Array__Agent*, int, Agent);

// Depth 103
typedef Array__Agent(*Fn__Array__Agent_int_Array__Agent)(Array__Agent, int);
...
// Depth 103
typedef Array__Agent(*Fn__Fn__Agent_Agent_MUL__Array__Agent_Array__Agent)(Lambda*, Array__Agent);
...
// Depth 103
typedef Array__Agent(*Fn__int_Array__Agent)(int);
...
// Depth 103
typedef Array__Agent(*Fn__int_Fn__Array__Agent_Array__Agent_MUL__Array__Agent_Array__Agent)(int, Lambda*, Array__Agent);

// Depth 103
typedef Array__Agent(*Fn__int_Fn___Agent_MUL__Array__Agent)(int, Lambda*);
...
// Depth 500
Agent _Lambda_create_MINUS_world_19();

// Depth 500
Array__Agent _Lambda_update_MINUS_world_17(Array__Agent w);

// Depth 500
Array__Agent create_MINUS_world(int n);
...
// Depth 500
Agent move_MINUS_agent(Agent agent);
...
// Depth 500
bool null_QMARK___char(char* p);

// Depth 500
Array__Agent update_MINUS_world(Array__Agent world, int steps);

// Depth 1000

// Depth 500
Agent Agent_copy(Agent* pRef);

// Depth 500
void Agent_delete(Agent p);

// Depth 500
Agent Agent_init(float x, float y);

// Depth 500
String Agent_prn(Agent *p);

// Depth 500
Agent Agent_set_MINUS_x(Agent p, float newValue);

// Depth 500
void Agent_set_MINUS_x_BANG_(Agent* pRef, float newValue);

// Depth 500
Agent Agent_set_MINUS_y(Agent p, float newValue);

// Depth 500
void Agent_set_MINUS_y_BANG_(Agent* pRef, float newValue);

// Depth 500
String Agent_str(Agent *p);

// Depth 500
Agent Agent_update_MINUS_x(Agent p, Lambda *updater);

// Depth 500
Agent Agent_update_MINUS_y(Agent p, Lambda *updater);

// Depth 500
float* Agent_x(Agent* p);

// Depth 500
float* Agent_y(Agent* p);

// Depth 1000

// Depth 500
Array Array_allocate__Agent (int n);
...
// Depth 500
void Array_aset_MINUS_uninitialized_BANG___Agent (Array *aRef, int n, Agent newValue);
...
// Depth 500
void Array_delete__Agent (Array a);
...
// Depth 500
Array Array_endo_MINUS_map__Agent(Lambda *f, Array a);

// Depth 500
int Array_length__Agent (Array *a);
...
// Depth 500
Array__Agent Array_repeat__Agent(int n, Lambda* f);
...
// Depth 500
Array__Agent Control_iterate__Array__Agent(int n, Lambda* f, Array__Agent start);
...
// Depth 500
void Function_delete__Agent (Lambda f);

// Depth 500
void Function_delete__Array__Agent_Array__Agent (Lambda f);
...
// Depth 500
bool Pointer_eq__char (char *p1, char *p2);
...
Agent Agent_copy(Agent* pRef) {
    Agent copy = *pRef;
    /* Ignore non-managed member 'x' : Float */
    /* Ignore non-managed member 'y' : Float */
    return copy;
}
...
String Agent_prn(Agent *p) {
  ...
  int size = snprintf(NULL, 0, "(%s )", "Agent");
  temp = Float_prn(p->x); 
  ...
  sprintf(bufferPtr, "(%s ", "Agent");
  bufferPtr += strlen("Agent") + 2;
...
Agent Agent_update_MINUS_x(Agent p, Lambda *updater) {
    p.x = (*updater).env ? ((Fn__LambdaEnv_float_float)(*updater).callback)((*updater).env, p.x) : ((Fn__float_float)(*updater).callback)(p.x);
    return p;
}


Agent Agent_update_MINUS_y(Agent p, Lambda *updater) {
    p.y = (*updater).env ? ((Fn__LambdaEnv_float_float)(*updater).callback)((*updater).env, p.y) : ((Fn__float_float)(*updater).callback)(p.y);
    return p;
}


float* Agent_x(Agent* p) { return (&(p->x)); }

float* Agent_y(Agent* p) { return (&(p->y)); }

Array Array_allocate__Agent (int n) {
    Array a;
    a.len = n;
    a.capacity = n;
    a.data = CARP_MALLOC(n*sizeof(Agent));
    return a;
}
...
Array Array_endo_MINUS_map__Agent(Lambda *f, Array a) { 
    for(int i = 0; i < a.len; ++i) {
        ((Agent*)a.data)[i] = (*f).env ? ((Fn__LambdaEnv_Agent_Agent)(*f).callback)((*f).env, (((Agent*)a.data)[i])) : ((Fn__Agent_Agent)(*f).callback)((((Agent*)a.data)[i]));
    }
    return a;
}

int Array_length__Agent (Array *a) { return (*a).len; }
...
Array__Agent Array_repeat__Agent(int n, Lambda* f) {
    Array__Agent _44;
    /* let */ {
        Array__Agent _9 = Array_allocate__Agent(n);
        Array__Agent a = _9;
        /* let */ {
            int i = 0;
            ...
            bool _40 = _20;
            while (_40) {
                Array__Agent* _25 = &a; // ref
                Agent _30 = (*f).env ? ((Agent(*)(LambdaEnv))(*f).callback)((*f).env) : ((Agent(*)())(*f).callback)();
                Array_aset_MINUS_uninitialized_BANG___Agent(_25, i, _30);
...
Result__Uint16_Array__uint8_t Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint16_29(Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint16_29_env* _env, Array__uint8_t* bs) {
    ...
    if(_14._tag == Maybe__Uint16_Nothing_tag) {
      ...
      fprintf(stderr, "Unhandled case in 'match' expression at line 92, column 8 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _28;
}
...
Maybe__Uint16 Binary_bytes_MINUS__GT_int16(ByteOrder order, Array__uint8_t* bytes) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 143, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _37;
}
...
Maybe__Uint32 Binary_bytes_MINUS__GT_int32(ByteOrder order, Array__uint8_t* bs) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 217, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _53;
}
...
Maybe__Uint64 Binary_bytes_MINUS__GT_int64(ByteOrder order, Array__uint8_t* bs) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 300, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _85;
}
...
Array__uint8_t Binary_int16_MINUS__GT_bytes(ByteOrder order, Uint16 i) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 153, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _41;
}
...
Array__uint8_t Binary_int32_MINUS__GT_bytes(ByteOrder order, Uint32 i) {
    ...
    /* let */ {
        ...
        if(order._tag == ByteOrder_LittleEndian_tag) {
          ...
          // This will not be needed with static exhaustiveness checking in 'match' expressions:
          fprintf(stderr, "Unhandled case in 'match' expression at line 230, column 7 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
          exit(1);
        }
        _61 = _60;
...
Array__uint8_t Binary_int64_MINUS__GT_bytes(ByteOrder order, Uint64 i) {
    ...
    /* let */ {
        ...
        if(order._tag == ByteOrder_LittleEndian_tag) {
          ...
          // This will not be needed with static exhaustiveness checking in 'match' expressions:
          fprintf(stderr, "Unhandled case in 'match' expression at line 316, column 7 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
          exit(1);
        }
        _85 = _84;
...
Uint16 Binary_unsafe_MINUS_bytes_MINUS__GT_int16(ByteOrder order, Array__uint8_t* bs) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 130, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _39;
}
...
Uint32 Binary_unsafe_MINUS_bytes_MINUS__GT_int32(ByteOrder order, Array__uint8_t* bs) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 202, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _63;
}
...
Uint64 Binary_unsafe_MINUS_bytes_MINUS__GT_int64(ByteOrder order, Array__uint8_t* bs) {
    ...
    if(order._tag == ByteOrder_LittleEndian_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 281, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _111;
}
...
Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint16_29_env* Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint16_29_env_copy(Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint16_29_env* pRef) {
    ...
    *copy = *pRef;
    /* Ignore non-managed member 'f' : (Ref (λ [ByteOrder, (Ref (Array Byte) c)] (Maybe Uint16)) StaticLifetime) */
...
Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint32_29_env* Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint32_29_env_copy(Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint32_29_env* pRef) {
    ...
    *copy = *pRef;
    /* Ignore non-managed member 'f' : (Ref (λ [ByteOrder, (Ref (Array Byte) c)] (Maybe Uint32)) StaticLifetime) */
    copy->order = ByteOrder_copy(&(pRef->order));
    return copy;
}
...
Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint64_29_env* Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint64_29_env_copy(Binary__Lambda_byte_MINUS_converter__ByteOrder_Array__uint8_t_Uint64_29_env* pRef) {
    ...
    *copy = *pRef;
    /* Ignore non-managed member 'f' : (Ref (λ [ByteOrder, (Ref (Array Byte) c)] (Maybe Uint64)) StaticLifetime) */
    copy->order = ByteOrder_copy(&(pRef->order));
    return copy;
}
...
int Char_meaning(char* char_MINUS_ref) {
    ...
    /* let */ {
        ...
        char c = _8;
        int _120;
        bool _14 = Char__EQ_(c, '0');
        if (_14) {
            int _17 = 0;
            _120 = _17;
        } else {
            int _118;
            bool _23 = Char__EQ_(c, '1');
            if (_23) {
                int _26 = 1;
                _118 = _26;
            } else {
                int _116;
                bool _32 = Char__EQ_(c, '2');
                if (_32) {
                    int _35 = 2;
                    _116 = _35;
                } else {
                    int _114;
                    bool _41 = Char__EQ_(c, '3');
                    if (_41) {
                        int _44 = 3;
                        _114 = _44;
                    } else {
                        int _112;
                        bool _50 = Char__EQ_(c, '4');
                        if (_50) {
                            int _53 = 4;
                            _112 = _53;
                        } else {
                            int _110;
                            bool _59 = Char__EQ_(c, '5');
                            if (_59) {
                                int _62 = 5;
                                _110 = _62;
                            } else {
                                int _108;
                                bool _68 = Char__EQ_(c, '6');
                                if (_68) {
                                    int _71 = 6;
                                    _108 = _71;
                                } else {
                                    int _106;
                                    bool _77 = Char__EQ_(c, '7');
                                    if (_77) {
                                        int _80 = 7;
                                        _106 = _80;
                                    } else {
                                        int _104;
                                        bool _86 = Char__EQ_(c, '8');
                                        if (_86) {
                                            int _89 = 8;
                                            _104 = _89;
                                        } else {
                                            int _102;
                                            bool _95 = Char__EQ_(c, '9');
                                            if (_95) {
                                                int _98 = 9;
                                                _102 = _98;
                                            } else {
...
Array__Agent Control_iterate__Array__Agent(int n, Lambda* f, Array__Agent start) {
    Array__Agent _41;
    /* let */ {
        Array__Agent result = start;
        /* let */ {
            int i = 0;
            bool _19 = Int__LT_(i, n);
            bool _37 = _19;
            while (_37) {
                Array__Agent _27 = (*f).env ? ((Array__Agent(*)(LambdaEnv, Array__Agent))(*f).callback)((*f).env, result) : ((Array__Agent(*)(Array__Agent))(*f).callback)(result);
                result = _27;  // (Array Agent) = (Array Agent)
                int _34 = Int__PLUS_(i, 1);
                i = _34;  // Int = Int
                bool _19 = Int__LT_(i, n);
                _37 = _19;
            }
        }
        Array__Agent _40 = result;
        _41 = _40;
    }
    return _41;
}
...
Result__String_int IO_read_MINUS__GT_EOF(String* filename) {
    ...
    /* let */ {
        ...
        if(maybe._tag == Result__FILE_MUL__int_Error_tag) {
          ...
          // This will not be needed with static exhaustiveness checking in 'match' expressions:
          fprintf(stderr, "Unhandled case in 'match' expression at line 64, column 7 in '/Users/erik/Projects/Carp/core/IO.carp'\n");
          exit(1);
        }
        _64 = _63;
    }
...
Maybe__Uint32 Maybe_zip4__uint8_t_uint8_t_uint8_t_uint8_t_Uint32(Lambda* f, Maybe__uint8_t a, Maybe__uint8_t b, Maybe__uint8_t c, Maybe__uint8_t d) {
    ...
    if(a._tag == Maybe__uint8_t_Nothing_tag) {
        ...
        if(b._tag == Maybe__uint8_t_Nothing_tag) {
            ...
            if(c._tag == Maybe__uint8_t_Nothing_tag) {
                ...
                if(d._tag == Maybe__uint8_t_Nothing_tag) {
                  ...
                  // This will not be needed with static exhaustiveness checking in 'match' expressions:
                  fprintf(stderr, "Unhandled case in 'match' expression at line 26, column 11 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
                  exit(1);
                }
                _55 = _54;
            }
              ...
              // This will not be needed with static exhaustiveness checking in 'match' expressions:
              fprintf(stderr, "Unhandled case in 'match' expression at line 23, column 9 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
              exit(1);
            }
            _56 = _55;
        }
          ...
          // This will not be needed with static exhaustiveness checking in 'match' expressions:
          fprintf(stderr, "Unhandled case in 'match' expression at line 20, column 7 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
          exit(1);
        }
        _57 = _56;
    }
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 17, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _57;
}
...
Maybe__Uint64 Maybe_zip8__uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_Uint64(Lambda* f, Maybe__uint8_t a, Maybe__uint8_t b, Maybe__uint8_t c, Maybe__uint8_t d, Maybe__uint8_t e, Maybe__uint8_t a1, Maybe__uint8_t b1, Maybe__uint8_t c1) {
    ...
    if(a._tag == Maybe__uint8_t_Nothing_tag) {
        ...
        if(b._tag == Maybe__uint8_t_Nothing_tag) {
            ...
            if(c._tag == Maybe__uint8_t_Nothing_tag) {
                ...
                if(d._tag == Maybe__uint8_t_Nothing_tag) {
                    ...
                    if(e._tag == Maybe__uint8_t_Nothing_tag) {
                        ...
                        if(a1._tag == Maybe__uint8_t_Nothing_tag) {
                            ...
                            if(b1._tag == Maybe__uint8_t_Nothing_tag) {
                                ...
                                if(c1._tag == Maybe__uint8_t_Nothing_tag) {
                                  ...
                                  // This will not be needed with static exhaustiveness checking in 'match' expressions:
                                  fprintf(stderr, "Unhandled case in 'match' expression at line 52, column 18 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
                                  exit(1);
                                }
                                _99 = _98;
                            }
                              ...
                              // This will not be needed with static exhaustiveness checking in 'match' expressions:
                              fprintf(stderr, "Unhandled case in 'match' expression at line 49, column 16 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
                              exit(1);
                            }
                            _100 = _99;
                        }
                          ...
                          // This will not be needed with static exhaustiveness checking in 'match' expressions:
                          fprintf(stderr, "Unhandled case in 'match' expression at line 46, column 14 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
                          exit(1);
                        }
                        _101 = _100;
                    }
                      ...
                      // This will not be needed with static exhaustiveness checking in 'match' expressions:
                      fprintf(stderr, "Unhandled case in 'match' expression at line 43, column 12 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
                      exit(1);
                    }
                    _102 = _101;
                }
                  ...
                  // This will not be needed with static exhaustiveness checking in 'match' expressions:
                  fprintf(stderr, "Unhandled case in 'match' expression at line 40, column 10 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
                  exit(1);
                }
                _103 = _102;
            }
              ...
              // This will not be needed with static exhaustiveness checking in 'match' expressions:
              fprintf(stderr, "Unhandled case in 'match' expression at line 37, column 8 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
              exit(1);
            }
            _104 = _103;
        }
          ...
          // This will not be needed with static exhaustiveness checking in 'match' expressions:
          fprintf(stderr, "Unhandled case in 'match' expression at line 34, column 6 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
          exit(1);
        }
        _105 = _104;
    }
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 31, column 4 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _105;
}
...
Maybe__Uint16 Maybe_zip__uint8_t_uint8_t_Uint16(Lambda* f, Maybe__uint8_t a, Maybe__uint8_t b) {
    ...
    if(a._tag == Maybe__uint8_t_Nothing_tag) {
        ...
        if(b._tag == Maybe__uint8_t_Nothing_tag) {
          ...
          // This will not be needed with static exhaustiveness checking in 'match' expressions:
          fprintf(stderr, "Unhandled case in 'match' expression at line 12, column 7 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
          exit(1);
        }
        _33 = _32;
    }
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 9, column 5 in '/Users/erik/Projects/Carp/core/Binary.carp'\n");
      exit(1);
    }
    return _33;
}
...
bool Result_error_QMARK___Uint16_Array__uint8_t(Result__Uint16_Array__uint8_t* a) {
    Result__Uint16_Array__uint8_t _7 = Result_copy__Uint16_Array__uint8_t(a);
    bool _16;
    if(_7._tag == Result__Uint16_Array__uint8_t_Error_tag) {
        Result__Uint16_Array__uint8_t _7_temp = _7;
        Array__uint8_t wildcard_9 = _7_temp.Error.member0;
        _16 = true;
        Array_delete__uint8_t(wildcard_9);
    }
    else if(_7._tag == Result__Uint16_Array__uint8_t_Success_tag) {
        Result__Uint16_Array__uint8_t _7_temp = _7;
        Uint16 wildcard_13 = _7_temp.Success.member0;
        _16 = false;
    }
    else {
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 94, column 5 in '/Users/erik/Projects/Carp/core/Result.carp'\n");
      exit(1);
    }
    return _16;
}
...
bool Result_error_QMARK___Uint32_Array__uint8_t(Result__Uint32_Array__uint8_t* a) {
    Result__Uint32_Array__uint8_t _7 = Result_copy__Uint32_Array__uint8_t(a);
    bool _16;
    if(_7._tag == Result__Uint32_Array__uint8_t_Error_tag) {
        Result__Uint32_Array__uint8_t _7_temp = _7;
        Array__uint8_t wildcard_9 = _7_temp.Error.member0;
        _16 = true;
        Array_delete__uint8_t(wildcard_9);
    }
    else if(_7._tag == Result__Uint32_Array__uint8_t_Success_tag) {
        Result__Uint32_Array__uint8_t _7_temp = _7;
        Uint32 wildcard_13 = _7_temp.Success.member0;
        _16 = false;
    }
    else {
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
...
bool Result_error_QMARK___Uint64_Array__uint8_t(Result__Uint64_Array__uint8_t* a) {
    Result__Uint64_Array__uint8_t _7 = Result_copy__Uint64_Array__uint8_t(a);
    bool _16;
    if(_7._tag == Result__Uint64_Array__uint8_t_Error_tag) {
        Result__Uint64_Array__uint8_t _7_temp = _7;
        Array__uint8_t wildcard_9 = _7_temp.Error.member0;
        _16 = true;
        Array_delete__uint8_t(wildcard_9);
    }
    else if(_7._tag == Result__Uint64_Array__uint8_t_Success_tag) {
        Result__Uint64_Array__uint8_t _7_temp = _7;
        Uint64 wildcard_13 = _7_temp.Success.member0;
        _16 = false;
    }
    else {
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
...
Array__uint8_t Result_from_MINUS_error__Uint16_Array__uint8_t(Result__Uint16_Array__uint8_t a, Array__uint8_t dflt) {
    ...
    if(a._tag == Result__Uint16_Array__uint8_t_Success_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 70, column 5 in '/Users/erik/Projects/Carp/core/Result.carp'\n");
      exit(1);
    }
    return _15;
}
...
bool Result_success_QMARK___Uint16_Array__uint8_t(Result__Uint16_Array__uint8_t* a) {
    ...
    if(_7._tag == Result__Uint16_Array__uint8_t_Error_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 86, column 5 in '/Users/erik/Projects/Carp/core/Result.carp'\n");
      exit(1);
    }
    return _16;
}
...
Uint16 Result_unwrap_MINUS_or_MINUS_zero__Uint16_Array__uint8_t(Result__Uint16_Array__uint8_t a) {
    ...
    if(a._tag == Result__Uint16_Array__uint8_t_Success_tag) {
      ...
      // This will not be needed with static exhaustiveness checking in 'match' expressions:
      fprintf(stderr, "Unhandled case in 'match' expression at line 34, column 5 in '/Users/erik/Projects/Carp/core/Result.carp'\n");
      exit(1);
    }
    return _15;
}
...
String String_join(String* sep, Array__String* strings) {
    ...
    /* let */ {
        ...
        String _38 = String_allocate(_36, ' ');
        String result = _38;
        /* let */ {
            int i = 0;
...
String String_join_MINUS_with_MINUS_char(char sep, Array__String* strings) {
    ...
    /* let */ {
        ...
        String _29 = String_allocate(_27, ' ');
        String result = _29;
        /* let */ {
            int i = 0;
...
String String_repeat(int n, String* inpt) {
    ...
    /* let */ {
        ...
        String _17 = String_allocate(_15, '0');
        String str = _17;
        /* let */ {
            int i = 0;
...
Agent _Lambda_create_MINUS_world_19() {
    float _13 = Float_random_MINUS_between(0.0f, 100.0f);
    float _17 = Float_random_MINUS_between(0.0f, 100.0f);
    Agent _18 = Agent_init(_13, _17);
    return _18;
}

Array__Agent _Lambda_update_MINUS_world_17(Array__Agent w) {
    Lambda _13 = { .callback = move_MINUS_agent, .env = NULL, .delete = NULL, .copy = NULL }; //Sym move-agent (LookupGlobal CarpLand AFunction)
    Lambda* _14 = &_13; // ref
    Array__Agent _16 = Array_endo_MINUS_map__Agent(_14, w);
    return _16;
}
...
Array__Agent create_MINUS_world(int n) {
    // This lambda captures 0 variables: 
    Lambda _19 = {
      .callback = _Lambda_create_MINUS_world_19,
      .env = NULL,
      .delete = NULL,
      .copy = NULL
    };
    Lambda* _20 = &_19; // ref
    Array__Agent _21 = Array_repeat__Agent(n, _20);
    Function_delete__Agent(_19);
    return _21;
}
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        Array__Agent _7 = create_MINUS_world(10000);
        Array__Agent start = _7;
        Array__Agent _12 = update_MINUS_world(start, 10000);
        Array__Agent result = _12;
        static String _19 = "Done updating ";
        String *_19_ref = &_19;
        String _20 = String_str(_19_ref);
        String* _21 = &_20; // ref
        Array__Agent* _29 = &result; // ref
        int _30 = Array_length__Agent(_29);
        String _31 = Int_str(_30);
        String* _32 = &_31; // ref
        static String _35 = " agents.";
        String *_35_ref = &_35;
        String _36 = String_str(_35_ref);
        String* _37 = &_36; // ref
        String _38 = String_append(_32, _37);
        String* _39 = &_38; // ref
        String _40 = String_append(_21, _39);
        String* _41 = &_40; // ref
        IO_println(_41);
        Array_delete__Agent(result);
        String_delete(_20);
        String_delete(_31);
        String_delete(_36);
        String_delete(_38);
...
Agent move_MINUS_agent(Agent agent) {
    Lambda _8 = { .callback = Float_inc, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Float.inc (LookupGlobal CarpLand AFunction)
    Lambda* _9 = &_8; // ref
    Agent _10 = Agent_update_MINUS_x(agent, _9);
    Lambda _12 = { .callback = Float_dec, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Float.dec (LookupGlobal CarpLand AFunction)
    Lambda* _13 = &_12; // ref
    Agent _14 = Agent_update_MINUS_y(_10, _13);
    return _14;
}
...
bool null_QMARK___char(char* p) {
    char* _11 = p; // From the 'the' function.
    bool _12 = Pointer_eq__char(NULL, _11);
    return _12;
}
...
Array__Agent update_MINUS_world(Array__Agent world, int steps) {
    // This lambda captures 0 variables: 
    Lambda _17 = {
      .callback = _Lambda_update_MINUS_world_17,
      .env = NULL,
      .delete = NULL,
      .copy = NULL
    };
    Lambda* _18 = &_17; // ref
    Array__Agent _20 = Control_iterate__Array__Agent(steps, _18, world);
    Function_delete__Array__Agent_Array__Agent(_17);
    return _20;
}
